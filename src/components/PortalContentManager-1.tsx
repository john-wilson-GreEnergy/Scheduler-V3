      ...
      <AnimatePresence>
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              <form onSubmit={activeTab === 'announcements' ? handleSaveAnnouncement : handleSaveAction}>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <input 
                        name="start_date"
                        type="date"
                        defaultValue={editingItem?.start_date || format(new Date(), 'yyyy-MM-dd')}
                        required
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:border-emerald-500 outline-none transition-all"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <input 
                        name="end_date"
                        type="date"
                        defaultValue={editingItem?.end_date || format(addDays(new Date(), 7), 'yyyy-MM-dd')}
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:border-emerald-500 outline-none transition-all"
                      />
                    </div>
                    <div className="flex items-center gap-3 pt-6">
